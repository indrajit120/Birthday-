import { BirthdayConfig } from './ConfigContext';
...
export const DEFAULT_CONFIG: BirthdayConfig = {
  ...
  friendshipRules: {
    ...
    rules: [
      {
        id: "1",
        text: "Reply to my texts within one business week",
        enabled: true,
        required: true,
        order: 1,
        icon: "📱"
      ...
      {
        id: "2",
        text: "Send me memes that remind you of me",
        enabled: true,
        required: true,
        order: 2,
        icon: "😂"
      ...
      {
        id: "3",
        text: "Never let me do anything stupid... alone",
        enabled: true,
        required: true,
        order: 3,
        icon: "👯"
